...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/resque/lonely_job/my_class.rb` -> `spec/resque/lonely_job/my_class_spec.rb`.
...
[🧪build]: https://github.com/resque/resque-lonely_job/actions
...
[✉️discord-invite-img]: https://img.shields.io/discord/1373797679469170758?style=for-the-badge&logo=discord
