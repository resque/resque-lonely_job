# kettle-jem:freeze
# To retain chunks of comments & code during resque-lonely_job templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# resque-lonely_job will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
