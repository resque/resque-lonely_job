...
# resque-lonely_job Rakefile v7.1.0 - 2026-08-01
...
# rake install                                # Build and install resque-lonely_job-1.0.0.gem in...
# rake install:local                          # Build and install resque-lonely_job-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template resque-lonely_job against itse...
